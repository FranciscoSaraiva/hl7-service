...
function createMSH(pedido) {
    return new hl7.Message( //'^~\&', //MSH.1 - Field Separator	1 [DEFAULT]
        ...
        'DESK-MEDIC', //MSH.3 - Sending Application	227	
        'DESK-MEDIC', //MSH.4 - Sending Facility	227	
        'DESK-SERVICES', //MSH.5 - Receiving Application	227	
        'DESK-SERVICES', //MSH.6 - Receiving Facility	227	
...
function createORC(pedido, message) {
    message.addSegment('ORC',
        ...
        'DESK-MEDIC', //ORC.10 - Entered By	250	
        'DESK-MEDIC', //ORC.11 - Verified By	250	
        ...
        'DESK-MEDIC', //ORC.19 - Action By	250	
...
function createOBR(pedido, message) {
    message.addSegment('OBR',
        ...
        '4727375', //OBR.2 - Placer Order Number	22	
        '4727375', //OBR.3 - Filler Order Number	22	
        ...
        pedido.estado, //OBR.25 - Result Status	1	
